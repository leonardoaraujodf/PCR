...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/ula_fixpoint/ula_fixpoint.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ula_fixpoint.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ula_fixpoint.tcl -notrace
