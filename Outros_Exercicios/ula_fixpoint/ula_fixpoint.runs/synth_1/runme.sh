...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/ula_fixpoint/ula_fixpoint.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ula_fixpoint.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ula_fixpoint.tcl
