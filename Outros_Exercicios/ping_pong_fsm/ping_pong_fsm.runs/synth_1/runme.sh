...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/PCR/Listas_de_Exercicios/ping_pong_fsm/ping_pong_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_ping_pong.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_ping_pong.tcl
