...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/PCR/Listas_de_Exercicios/ping_pong_fsm/ping_pong_fsm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_ping_pong.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_ping_pong.tcl -notrace
