...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/PCR/Listas_de_Exercicios/clkdiv/clkdiv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clockdiv10Hz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clockdiv10Hz.tcl
