...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/PCR/Listas_de_Exercicios/PCR2019_Ping_Pong/PCR2019_Ping_Pong.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ping_pong.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ping_pong.tcl
