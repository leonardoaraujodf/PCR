...
constant num_sum : integer := 2;

subtype mult_in is std_logic_vector (FP_WIDTH-1 downto 0);
type t_mult is array (0 to num_mult-1) of mult_in;

subtype sum_in is std_logic_vector (FP_WIDTH-1 downto 0);
type t_sum is array (0 to num_sum-1) of sum_in;
