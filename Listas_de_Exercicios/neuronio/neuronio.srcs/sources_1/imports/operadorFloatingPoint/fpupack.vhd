...
-- constante que define o numero de neuronios
constant numero_neuronios : integer := 7;
type num_neur is array (0 to numero_neuronios-1) of saida_mult;

--constante que define as entradas dos neuronios

type entr_neuron is array (0 to numero_neuronios-1) of t_mult;

--constante que define as saidas da RNA
constant num_saidas: integer := 3;
type saida_rna is array (0 to num_saidas-1) of saida_mult;
