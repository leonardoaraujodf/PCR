...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/floatingIP/floatingIP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplierfsm_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplierfsm_v2.tcl
