...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/PCR/Listas_de_Exercicios/clkdiv/clkdiv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clockdiv10Hz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clockdiv10Hz.tcl -notrace
