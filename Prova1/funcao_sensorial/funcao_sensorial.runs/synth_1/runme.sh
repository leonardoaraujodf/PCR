...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/PCR/Prova1/funcao_sensorial/funcao_sensorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sens_teste.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sens_teste.tcl
