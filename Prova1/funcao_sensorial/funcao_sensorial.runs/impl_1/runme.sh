...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/PCR/Prova1/funcao_sensorial/funcao_sensorial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sens_teste.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sens_teste.tcl -notrace
