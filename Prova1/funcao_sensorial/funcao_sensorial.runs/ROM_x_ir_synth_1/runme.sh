...
HD_PWD='C:/Users/Leonardo/Documents/Arquivos Leonardo/UnB/9 Semestre/Projeto de Circuitos Reconfiguraveis/PCR/Prova1/funcao_sensorial/funcao_sensorial.runs/ROM_x_ir_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_x_ir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_x_ir.tcl
