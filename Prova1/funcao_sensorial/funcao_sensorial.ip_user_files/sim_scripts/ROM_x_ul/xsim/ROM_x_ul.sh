...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot ROM_x_ul xil_defaultlib.ROM_x_ul -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROM_x_ul -key {Behavioral:sim_1:Functional:ROM_x_ul} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROM_x_ul.wdb xsim.dir)
