...
#
# Generated by export_simulation on Thu May 09 12:38:06 -0300 2019
#
################################################################################
...
'-reset_run' switch to the './ROM_x_ir.sh' script.

./ROM_x_ir.sh -reset_run
...
./ROM_x_ir.sh -noclean_files

For more information on the script, please type './ROM_x_ir.sh -help'.
